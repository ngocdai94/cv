...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CUSTOM CONSTANTS for Bullet Points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newlength{\quoteleftskip}            % define a new length for competencies
\newlength{\quoteleftskipAdditional}  % define a new length for additional skills
\setlength{\quoteleftskip}{-10pt}  
\setlength{\quoteleftskipAdditional}{-18pt}
